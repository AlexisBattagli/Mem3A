...
\newglossaryentry{cwmpg}{
	name={CWMP},
	description={Protocole du \gls{doc_tr069g}. C’est le protocole de 						communication employé pour que les serveurs \gls{acs} et les équipements 					puissent dialoguer}
} 
