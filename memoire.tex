...
\paragraph*{}De plus, je souhaite remercier Emna MEZGHANI et Samuel BERLEMONT qui ont participé à la relecture de mon mémoire.
\paragraph*{}Enfin, je remercie Aurélie GUY, Tommy VALETTE et Amine BOUROUIBA, tous trois élèves de ma promotion, pour la relecture de ce mémoire et les nombreux projets réalisés et menés à bien ensemble tout au long de ces trois années.
...
\paragraph*{}This goal of this paper is bring into light the development and evolution of my skills - both on a technical and transversal field - during these three years of apprenticeship I have spent at the Institut des Mines Télécoms Mines d'Alès. This apprenticeship has been made at Orange Labs at Grenoble, in the R\&D department. My main focus there has been the Device Management, and more specifically, the validation of implementation of the CWMP protocol on devices managed by Orange. Thereby, this document aims to reflect my progression from technician to engineer through my development skills on the CWMP protocol, my conception of validation tools, to finally become a referent for the validation of the implementation of CWMP protocol at Orange. I will first introduce the device management and CWMP protocol, then I will demonstrate my skill evolution on the CWMP protocol, and I will finally emphasise my work on my main project : The conception, design and devellopment of a validation tool for the implementation of the CWMP protocol on customer devices.
