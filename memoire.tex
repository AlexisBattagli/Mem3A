...
\paragraph*{} Ce standard décrit un modèle de donnée, que l'on nomme \gls{datamodelg}, comportant une partie commune, pour chaque équipement implémentant le \gls{doctr069g} et pouvant ainsi être manager par un \gls{acs}.
