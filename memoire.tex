...
\begin{table}
	\begin{tabularx}{16cm}{|X|X|X|}
		...
		\end{tabularx}
	\centering
	\caption{Synthèse des missions effectuées et compétences développées (part 1/3)}
\end{table}
...
\begin{table}
	\begin{tabularx}{16cm}{|X|X|X|}
		...
		Séance de créativité 
			& 
				\begin{itemize}
				\item Participation à des réuinon de créativité du Device Management
				\end{itemize}
			&  \tabularnewline
		\hline
		...
		\end{tabularx}
	\centering
	\caption{Synthèse des missions effectuées et compétences développées (part 2/3)}
\end{table}
...
\begin{table}
	\begin{tabularx}{16cm}{|X|X|X|}
		...
		\end{tabularx}
	\centering
	\caption{Synthèse des missions effectuées et compétences développées (part 3/3)}
\end{table}
