...
\paragraph*{}Lors de l'étude précédente, uniquement des clients open source ont été tester et comparer. Il est ici question de comparer le clients EasyCWMP, lequel est ressorti comme étant le plus prometteur de la précédente étude, le client tr69agent. Ce client a été développé par Orange...
\subsubsection{Résultats} %conséquence : création du projet toolkit !
